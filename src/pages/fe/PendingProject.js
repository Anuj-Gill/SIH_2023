              ...
              grievances.map((row, index) => (
                <TableRow key={row._id} sx={{ "&:last-child td, &:last-child th": { border: 0 }, padding: 8 }}>
                  ...
                  <TableCell align="right">
                    <Chip
                      label={row.status}
                      sx={{ backgroundColor: "#f44336", color: "#fff", width: 70 }}
                      size="small"
                    />
                  </TableCell>
...
const data = [
  ...
  },
  {
    ...
    title: "title 23",
    description: "description",
    deadline: new Date(2022, 11, 2, 10, 33, 30),
    department: "Department 2",
    type: "type 31",
    category: "category",
    status: "Pending",
    createdAt: new Date(2022, 6, 28, 10, 33, 30),
  },
  {
    _id: 4,
    title: "title 4",
    ...
    category: "category",
    status: "Pending",
    createdAt: new Date(2022, 6, 5, 10, 33, 30),
  },
];
