...
import { getAllStreams, addStream, updateStream, deleteStream } from "../../api/services/baseTables/streams";
    ...
    <>
      ...
      <Dialog
        ...
        <DialogActions>
          ...
          <Button onClick={handleAdd} disabled={!streamName || !streamDesc || !streamCourses}>
            Add
          </Button>
        </DialogActions>
      </Dialog>
      ...
      <Dialog
        ...
        <DialogActions>
          ...
          <Button onClick={handleUpdate} disabled={!streamName || !streamDesc || !streamCourses}>
            Save
          </Button>
        </DialogActions>
      </Dialog>
